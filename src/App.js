...
class App extends Component {
  ...
  handleSubmit = async e => {
    ...
    const response = await fetch(`http://18.230.151.33:1337/api/v1/admin/getFileByName`, {
      method: 'POST',
      headers: {
  ...
  handleSubmitLogin = async e => {
    ...
    const response = await fetch(`http://18.230.151.33:1337/api/v1/admin/authorization`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  handleSubmitSaveFile = async e => {
    ...
    const response = await fetch(`http://18.230.151.33:1337/api/v1/admin/editFileByName`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  render() {
    ...
    if (this.state.isLogged) {
      ...
      const apiOptions = {
        ...
        apiRoot: `http://18.230.151.33:1337/fileManager` // Or you local Server Node V1 installation.
      }
